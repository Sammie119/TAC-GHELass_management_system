...
@section('page-title', 'Record Visitor')
@section('content')

    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1.5rem;">
        <div>
            <h2 style="font-size:18px;font-weight:600;color:#111827;">Record New Visitor</h2>
            <p style="font-size:13px;color:#9ca3af;margin-top:2px;">Log a first-time or returning visitor</p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.visitors.store') }}">
        ...
        <div style="display:grid;grid-template-columns:1fr;gap:24px;">
            <style>@media(min-width:1024px){.visitor-grid{grid-template-columns:2fr 1fr !important;}}</style>
            <div style="display:grid;gap:24px;" class="visitor-grid">
                ...
                <div style="background:white;border-radius:12px;border:1px solid #e5e7eb;padding:24px;">
                    ...
                    <div>
                        ...
                        <textarea name="notes" rows="3"
                                  placeholder="e.g. Invited by John Doe, interested in joining..."
                ...
                <div style="display:flex;flex-direction:column;gap:16px;">
                    ...
                    <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:12px;padding:16px;">
                        <p style="font-size:13px;font-weight:500;color:#15803d;margin-bottom:6px;">Tip</p>
                        <p style="font-size:12px;color:#166534;line-height:1.6;">
                            Recording phone or email allows you to track if this visitor returns and follow up with them later.
                        </p>
                    </div>
                </div>
